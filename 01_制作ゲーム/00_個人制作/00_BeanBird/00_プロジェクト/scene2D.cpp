...
#define EXPLOSION_ANIM_X		((fTexU * nAnimPattern))	// 読み込むテクスチャのパターン
...
void CScene2D::Update(void)
{
	...
	//頂点座標の設定
	pVtx[0].pos = D3DXVECTOR3(m_pos.x + sinf(-D3DX_PI * 0.75f) * 50, m_pos.y + cosf(-D3DX_PI * 0.75f) * 50, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(m_pos.x + sinf(D3DX_PI * 0.75f) * 50, m_pos.y + cosf(D3DX_PI * 0.75f) * 50, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(m_pos.x + sinf(-D3DX_PI * 0.25f) * 50, m_pos.y + cosf(-D3DX_PI * 0.25f) * 50, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(m_pos.x + sinf(D3DX_PI * 0.25f) * 50, m_pos.y + cosf(D3DX_PI * 0.25f) * 50, 0.0f);
...
// オブジェクトテクスチャの設置処理
//=============================================================================
void CScene2D::SetTex(int nAnimPattern,float texU,float texV)
{
	float fTexU,fTexV;
	//テクスチャサイズを求める
	fTexU = 1 / texU;
	...
	pVtx[1].tex = D3DXVECTOR2(fTexU + EXPLOSION_ANIM_X, 0.0f);
	pVtx[2].tex = D3DXVECTOR2(0.0f + EXPLOSION_ANIM_X, 1.0f);
	pVtx[3].tex = D3DXVECTOR2(fTexU + EXPLOSION_ANIM_X, 1.0f);
